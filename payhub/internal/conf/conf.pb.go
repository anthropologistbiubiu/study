...
type Server struct {
	...
	Http1 *Server_HTTP `protobuf:"bytes,1,opt,name=http1,proto3" json:"http1,omitempty"`
	Http2 *Server_HTTP `protobuf:"bytes,2,opt,name=http2,proto3" json:"http2,omitempty"`
...
func (x *Server) GetHttp1() *Server_HTTP {
	if x != nil {
		return x.Http1
	}
	return nil
...
func (x *Server) GetHttp2() *Server_HTTP {
	if x != nil {
		return x.Http2
	}
	return nil
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x05, 0x68, 0x74, 0x74, 0x70, 0x31,
	...
	0x05, 0x68, 0x74, 0x74, 0x70, 0x31, 0x12, 0x2d, 0x0a, 0x05, 0x68, 0x74, 0x74, 0x70, 0x32, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x52, 0x05,
	0x68, 0x74, 0x74, 0x70, 0x32, 0x12, 0x2b, 0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x03, 0x20,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x1b, 0x5a, 0x19, 0x70, 0x61, 0x79, 0x68,
	0x75, 0x62, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e, 0x66,
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Server.http1:type_name -> kratos.api.Server.HTTP
	3,  // 3: kratos.api.Server.http2:type_name -> kratos.api.Server.HTTP
