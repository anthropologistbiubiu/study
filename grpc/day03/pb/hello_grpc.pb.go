...
type GreeterClient interface {
	...
	BidirectionalWithMetadata(ctx context.Context, opts ...grpc.CallOption) (Greeter_BidirectionalWithMetadataClient, error)
...
func (c *greeterClient) BidirectionalWithMetadata(ctx context.Context, opts ...grpc.CallOption) (Greeter_BidirectionalWithMetadataClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[3], "/pb.Greeter/bidirectionalWithMetadata", opts...)
	if err != nil {
		return nil, err
	}
	x := &greeterBidirectionalWithMetadataClient{stream}
	return x, nil
}

type Greeter_BidirectionalWithMetadataClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greeterBidirectionalWithMetadataClient struct {
	grpc.ClientStream
}

func (x *greeterBidirectionalWithMetadataClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterBidirectionalWithMetadataClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *greeterClient) BidirectionalStreamingSayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_BidirectionalStreamingSayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[4], "/pb.Greeter/BidirectionalStreamingSayHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterBidirectionalStreamingSayHelloClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	...
	BidirectionalWithMetadata(Greeter_BidirectionalWithMetadataServer) error
...
func (UnimplementedGreeterServer) BidirectionalWithMetadata(Greeter_BidirectionalWithMetadataServer) error {
	return status.Errorf(codes.Unimplemented, "method BidirectionalWithMetadata not implemented")
}
...
func _Greeter_BidirectionalWithMetadata_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).BidirectionalWithMetadata(&greeterBidirectionalWithMetadataServer{stream})
}

type Greeter_BidirectionalWithMetadataServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greeterBidirectionalWithMetadataServer struct {
	grpc.ServerStream
}

func (x *greeterBidirectionalWithMetadataServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterBidirectionalWithMetadataServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterBidirectionalStreamingSayHelloServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "bidirectionalWithMetadata",
			Handler:       _Greeter_BidirectionalWithMetadata_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
